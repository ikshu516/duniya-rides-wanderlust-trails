...
export const destinationsData: Destination[] = [
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/7/71/Dudhsagar_Falls%2C_Goa_%2851821730751%29.jpg',
        category: 'nature'
      },
      {
        name: 'Anjuna Beach',
        description: 'Famous for its Wednesday flea market and vibrant nightlife',
        image: 'https://upload.wikimedia.org/wikipedia/commons/8/8b/Anjuna_Beach_25012016.jpg',
        category: 'beach'
      },
      {
        name: 'Fort Aguada',
        description: '17th-century Portuguese fort with panoramic coastal views',
        image: 'https://upload.wikimedia.org/wikipedia/commons/9/95/Fort_Aguada_Remote_view_25012016.jpg',
        category: 'heritage'
      },
      {
        name: 'Spice Plantations',
        description: 'Aromatic spice gardens offering guided tours and traditional meals',
        image: 'https://upload.wikimedia.org/wikipedia/commons/f/f3/Spice_Plantation_in_Goa.JPG',
        category: 'nature'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/b/b5/Solang_Valley%2C_Manali.jpg',
    ...
    attractions: [
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/d/d4/Rohtang_pass_from_sideway.jpg',
        category: 'nature'
      },
      {
        name: 'Hadimba Temple',
        description: 'Ancient wooden temple surrounded by cedar forests',
        image: 'https://upload.wikimedia.org/wikipedia/commons/2/28/Hadimba_Devi_Temple_Manali.jpg',
        category: 'spiritual'
      },
      {
        name: 'Old Manali',
        description: 'Charming area with cafes, markets, and traditional Himachali culture',
        image: 'https://upload.wikimedia.org/wikipedia/commons/6/6d/Kullu_Valley_at_dawn.jpg',
        category: 'cultural'
      },
      {
        name: 'Kasol & Tosh Valley',
        description: 'Scenic valleys perfect for trekking and nature walks',
        image: 'https://upload.wikimedia.org/wikipedia/commons/f/fe/Parvati_valley_near_Kasol%2C_Kullu_district_in_Himachal_04.jpg',
        category: 'nature'
      },
      {
        name: 'Mall Road',
        description: 'Main shopping street with local handicrafts and mountain views',
        image: 'https://upload.wikimedia.org/wikipedia/commons/d/de/Mall_Road%2C_Manali.jpg',
        category: 'cultural'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/4/41/East_facade_Hawa_Mahal_Jaipur_from_ground_level_%28July_2022%29_-_img_01.jpg',
    ...
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/f/f7/Jaipur_03-2016_02_Amber_Fort.jpg',
        category: 'heritage'
      },
      {
        name: 'Hawa Mahal',
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/4/40/Jaipur_03-2016_20_City_Palace_complex.jpg',
        category: 'heritage'
      },
      {
        name: 'Jantar Mantar',
        description: 'UNESCO World Heritage astronomical observatory',
        image: 'https://upload.wikimedia.org/wikipedia/commons/9/9c/Jaipur_Jantar_Mantar_panorama_2011.jpg',
        category: 'heritage'
      },
      {
        name: 'Johari Bazaar',
        description: 'Famous jewelry market in the heart of Pink City',
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/0c/Johari_Bazaar%2C_Jaipur.jpg',
        category: 'cultural'
      },
      {
        name: 'Jaigarh Fort',
        description: 'Military fort housing the world\'s largest cannon',
        image: 'https://upload.wikimedia.org/wikipedia/commons/6/63/Jaigarh_Fort%2C_Jaipur%2C_20191218_1554_9349.jpg',
        category: 'heritage'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/1/17/Dal_Lake%2C_Srinagar%2C_Jammu_and_Kashmir.jpg',
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/3/31/Houseboat_on_Alleppey_backwaters_%28Kerala%2C_India_2023%29_%2852704323376%29.jpg',
    ...
    attractions: [
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/3/38/Munnar_tea_gardens.jpg',
        category: 'beach'
      },
      {
        name: 'Periyar Wildlife Sanctuary',
        description: 'Wildlife sanctuary famous for elephants and boat safaris',
        image: 'https://upload.wikimedia.org/wikipedia/commons/7/77/A_view_of_Periyar_Wildlife_Sanctuary_from_boat.jpg',
        category: 'beach'
      },
      {
        name: 'Fort Kochi',
        description: 'Historic port city with colonial architecture',
        image: 'https://upload.wikimedia.org/wikipedia/commons/e/ed/Sunset_with_Chinese_Fishing_Nets%2C_Fort_Kochi_1.jpg',
        category: 'heritage'
      },
      {
        name: 'Wayanad Hills',
        description: 'Misty hills with coffee plantations and waterfalls',
        image: 'https://upload.wikimedia.org/wikipedia/commons/3/3b/Wayanad_Hills.JPG',
        category: 'beach'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/f/f7/Jaipur_03-2016_02_Amber_Fort.jpg',
    bestTimeToVisit: 'October to March',
    category: 'heritage',
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/5/5e/Jaisalmer_Fort%2C_India.jpg',
        category: 'heritage'
      },
      {
        name: 'Udaipur City Palace',
        description: 'Magnificent palace complex on Lake Pichola',
        image: 'https://upload.wikimedia.org/wikipedia/commons/8/82/City_Palace_Udaipur_Rajasthan_India.JPG',
        category: 'heritage'
      },
      {
        name: 'Thar Desert',
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/2/23/20191210_Mehrangarh_Fort%2C_Jodhpur_1016_7834.jpg',
        category: 'heritage'
      },
      {
        name: 'Lake Palace',
        description: 'Floating palace on Lake Pichola',
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/07/Taj_Lake_Palace_Udaipur_from_City_Palace.jpg',
        category: 'heritage'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/7/74/Taj_Mahal%2C_Agra%2C_India_edit2.jpg',
    bestTimeToVisit: 'October to March',
    category: 'heritage',
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/7/74/Taj_Mahal%2C_Agra%2C_India_edit2.jpg',
        category: 'heritage'
      },
      {
        name: 'Agra Fort',
        description: 'Red sandstone Mughal fort with stunning architecture',
        image: 'https://upload.wikimedia.org/wikipedia/commons/6/68/Agra_03-2016_14_Agra_Fort.jpg',
        category: 'heritage'
      },
      {
        name: 'Fatehpur Sikri',
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/d/d4/Agra_03-2016_04_Taj_Mahal_from_Mehtab_Bagh.jpg',
        category: 'heritage'
      },
      {
        name: 'Akbar\'s Tomb',
        description: 'Magnificent tomb of Emperor Akbar in Sikandra',
        image: 'https://upload.wikimedia.org/wikipedia/commons/9/9d/Akbar%27s_Tomb_in_Sikandra_09.jpg',
        category: 'heritage'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/c/c1/State_Bank_of_India%2C_Chandni_Chowk_branch%2C_Delhi_04.jpg',
        category: 'cultural'
      },
      {
        name: 'Qutub Minar',
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/3/3a/Mumbai_03-2016_30_Gateway_of_India.jpg',
    ...
    attractions: [
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/Mumbai_03-2016_46_evening_at_Marine_Drive.jpg',
        category: 'cultural'
      },
      {
        name: 'Elephanta Caves',
        description: 'Ancient rock-cut caves dedicated to Lord Shiva',
        image: 'https://upload.wikimedia.org/wikipedia/commons/4/41/Elephanta_Caves%2C_India.jpg',
        category: 'heritage'
      },
      {
        name: 'Bandra–Worli Sea Link',
        description: 'Iconic cable-stayed bridge linking Bandra and Worli with stunning sea views',
        image: 'https://upload.wikimedia.org/wikipedia/commons/d/d5/Bandra_worli_sea-link_at_sunset.jpg',
        category: 'cultural'
      },
      {
        name: 'Chhatrapati Shivaji Terminus',
        description: 'UNESCO World Heritage Victorian Gothic railway station',
        image: 'https://upload.wikimedia.org/wikipedia/commons/c/c5/Chhatrapati_Shivaji_Terminus_%28Victoria_Terminus%29.jpg',
        category: 'heritage'
      },
      {
        name: 'Bollywood Studios',
        description: 'Film studios offering glimpses into Indian cinema',
        image: 'https://upload.wikimedia.org/wikipedia/commons/8/84/Film_City%2C_Mumbai.jpg',
        category: 'cultural'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/0/07/Taj_Lake_Palace_Udaipur_from_City_Palace.jpg',
    bestTimeToVisit: 'September to March',
    category: 'heritage',
    attractions: [
      {
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/2/28/City_Palace%2C_Udaipur%2C_20191207_0501_6900.jpg',
        category: 'heritage'
      },
      {
        name: 'Jag Mandir',
        description: 'Island palace known as Garden of the Lake',
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/0b/Jag_Mandir%2C_Udaipur%2C_20191207_1428_7201.jpg',
        category: 'heritage'
      },
      {
        name: 'Saheliyon Ki Bari',
        description: 'Beautiful garden with fountains and marble pavilions',
        image: 'https://upload.wikimedia.org/wikipedia/commons/f/fa/Saheliyon-ki-Bari_%28Udaipur%29.jpg',
        category: 'heritage'
      },
      {
        name: 'Monsoon Palace',
        description: 'Hilltop palace offering panoramic city views',
        image: 'https://upload.wikimedia.org/wikipedia/commons/4/4c/Monsoon_palace_udaipur.jpg',
        category: 'heritage'
      },
      {
        name: 'Fateh Sagar Lake',
        description: 'Artificial lake with boat rides and sunset views',
        image: 'https://upload.wikimedia.org/wikipedia/commons/a/a7/Fateh_Sagar_Lake%2C_Udaipur1.jpg',
        category: 'nature'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/5/5e/Ridge%2C_Shimla.JPG',
    bestTimeToVisit: 'March to June, October to February',
    category: 'mountain',
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/02/Bird_eye_View_of_Mall_Road_%2C_Shimla.jpg',
        category: 'cultural'
      },
      {
        name: 'Kalka-Shimla Toy Train',
        description: 'UNESCO World Heritage narrow gauge railway',
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/0f/Shimla_Railway_Station%2C_Himachal_Pradesh.jpg',
        category: 'heritage'
      },
      {
        name: 'Jakhu Temple',
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/f/fd/Christ_Church%2C_Shimla.jpg',
        category: 'heritage'
      },
      {
        name: 'Kufri',
        description: 'Hill station perfect for skiing and adventure sports',
        image: 'https://upload.wikimedia.org/wikipedia/commons/9/9b/Shimla_Reserve_Forest_Sanctuary%2C_Kufri.jpg',
        category: 'adventure'
      },
      {
        name: 'The Ridge',
        description: 'Open space with panoramic mountain views',
        image: 'https://upload.wikimedia.org/wikipedia/commons/5/5e/Ridge%2C_Shimla.JPG',
        category: 'nature'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/5/58/Ooty_lake%281%29.jpg',
        category: 'nature'
      },
      {
        name: 'Botanical Gardens',
        description: 'Sprawling gardens with rare plants and flower shows',
        image: 'https://upload.wikimedia.org/wikipedia/commons/c/c0/Plants_from_Government_Botanical_Garden%2C_Ooty_IMG20250629094231_%28Copy%29.jpg',
        category: 'nature'
      },
      {
        name: 'Doddabetta Peak',
        description: 'Highest peak in Nilgiris with panoramic views',
        image: 'https://upload.wikimedia.org/wikipedia/commons/b/b2/Doddabetta_Peak.jpg',
        category: 'nature'
      },
      {
        name: 'Tea Gardens',
        description: 'Rolling hills covered with lush tea plantations',
        image: 'https://upload.wikimedia.org/wikipedia/commons/4/41/Tea_Estate_in_Ooty%2C_Tamil_Nadu.JPG',
        category: 'nature'
      },
      {
        name: 'Rose Garden',
        description: 'Beautiful garden with thousands of rose varieties',
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/0d/Rose_Garden_View_in_Ooty%2C_Tamil_Nadu.JPG',
        category: 'nature'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/5/5a/Illuminated_Mysore_palace_at_night.JPG',
    bestTimeToVisit: 'October to March',
    category: 'heritage',
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/5/5a/Illuminated_Mysore_palace_at_night.JPG',
        category: 'heritage'
      },
      {
        name: 'Chamundi Hills',
        description: 'Sacred hill with Chamundeshwari Temple and city views',
        image: 'https://upload.wikimedia.org/wikipedia/commons/2/26/Chamundi_Temple_Mysore.jpg',
        category: 'spiritual'
      },
      {
        name: 'Brindavan Gardens',
        description: 'Musical fountain garden with terraced landscapes',
        image: 'https://upload.wikimedia.org/wikipedia/commons/f/f8/Musical_fountain_at_Brindavan_Gardens.jpg',
        category: 'nature'
      },
      {
        name: 'St. Philomena\'s Church',
        description: 'Neo-Gothic church with impressive twin spires',
        image: 'https://upload.wikimedia.org/wikipedia/commons/6/68/St._Philomena%27s_Church%2C_Mysore_01.jpg',
        category: 'heritage'
      },
      {
        name: 'Mysore Zoo',
        description: 'One of India\'s oldest and well-maintained zoos',
        image: 'https://upload.wikimedia.org/wikipedia/commons/1/1a/Girraffe_at_Mysore_zoo-1.jpg',
        category: 'nature'
      },
      {
        name: 'Devaraja Market',
        description: 'Colorful traditional market with spices and flowers',
        image: 'https://upload.wikimedia.org/wikipedia/commons/5/5f/Mysuru_-_Devaraja_Market_Entrance.jpg',
        category: 'cultural'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/8/84/Darjeeling_Tea_Garden_India.jpg',
    ...
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/2/2e/Tiger_Hill_sunrise_point%2C_Darjeeling.jpg',
        category: 'nature'
      },
      {
        name: 'Darjeeling Himalayan Railway',
        description: 'UNESCO World Heritage toy train through mountains',
        image: 'https://upload.wikimedia.org/wikipedia/commons/8/82/Darjeeling_Himalayan_Railway%2Ctoy_train_%289%29.jpg',
        category: 'heritage'
      },
      {
        name: 'Tea Gardens',
        description: 'World-famous tea estates with guided tours',
        image: 'https://upload.wikimedia.org/wikipedia/commons/8/84/Darjeeling_Tea_Garden_India.jpg',
        category: 'nature'
      },
      {
        name: 'Padmaja Naidu Himalayan Zoological Park',
        description: 'High-altitude zoo with snow leopards and red pandas',
        image: 'https://upload.wikimedia.org/wikipedia/commons/9/94/Padmaja_Naidu_Himalayan_Zoological_Park%2C_Darjeeling_Zoo.jpg',
        category: 'nature'
      },
      {
        name: 'Peace Pagoda',
        description: 'Japanese Buddhist temple with panoramic views',
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/0a/Japanese_Peace_Pagoda%2C_Darjeeling%2C_West_Bengal_03.jpg',
        category: 'spiritual'
      },
      {
        name: 'Mall Road',
        description: 'Historic shopping street with colonial buildings',
        image: 'https://upload.wikimedia.org/wikipedia/commons/5/5d/Mall_Road%2C_in_Darjeeling%2C_West_Bengal_07.jpg',
        category: 'cultural'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/1/17/River_Rafting_in_Ganga_Near_Ram_Jhula_Rishikesh_01.jpg',
    ...
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/3/35/Laxman_Jhula%2C_Rishikesh%2C_Uttarkhand%2C_India.jpg',
        category: 'heritage'
      },
      {
        name: 'Parmarth Niketan',
        description: 'Largest ashram with evening Ganga aarti ceremonies',
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/Ken_Wieland_Ganga_Aarti_in_Rishikesh.jpg',
        category: 'spiritual'
      },
      {
        name: 'Rajaji National Park',
        description: 'Wildlife sanctuary with elephants and diverse fauna',
        image: 'https://upload.wikimedia.org/wikipedia/commons/8/87/Rajaji_National_Park_Uttarakhand_India.jpg',
        category: 'nature'
      },
      {
        name: 'Ram Jhula',
        description: 'Sacred bridge connecting temples and ashrams',
        image: 'https://upload.wikimedia.org/wikipedia/commons/1/10/Ram_Jhula_footbridge_-_Rishikesh.jpg',
        category: 'spiritual'
      },
      {
        name: 'Beatles Ashram',
        description: 'Abandoned ashram where Beatles composed music',
        image: 'https://upload.wikimedia.org/wikipedia/commons/7/7c/Beatles_Ashram_01.jpg',
        category: 'cultural'
      },
      {
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/0/07/Panorama_of_Golden_Temple%2C_Amritsar_at_night.jpg',
    bestTimeToVisit: 'October to March',
    category: 'spiritual',
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/07/Panorama_of_Golden_Temple%2C_Amritsar_at_night.jpg',
        category: 'spiritual'
      },
      {
        name: 'Jallianwala Bagh',
        description: 'Memorial of tragic massacre during British rule',
        image: 'https://upload.wikimedia.org/wikipedia/commons/e/e1/Panorama_of_Jallianwala_Bagh-IMG_6348.jpg',
        category: 'heritage'
      },
      {
        name: 'Wagah Border',
        description: 'India-Pakistan border with ceremonial flag lowering',
        image: 'https://upload.wikimedia.org/wikipedia/commons/3/3a/International_border_at_Wagah_-_evening_flag_lowering_ceremony.jpg',
        category: 'cultural'
      },
      {
        name: 'Partition Museum',
        description: 'Museum documenting India\'s partition history',
        image: 'https://upload.wikimedia.org/wikipedia/commons/1/16/Partition_Museum%2C_Amritsar%2C_India.jpg',
        category: 'heritage'
      },
      {
        name: 'Akal Takht',
        description: 'Highest seat of Sikh religious authority',
        image: 'https://upload.wikimedia.org/wikipedia/commons/c/c4/Akal_Takht_and_Harmandir_Sahib%2C_Amritsar%2C_Punjab%2C_India.jpg',
        category: 'spiritual'
      },
      {
        name: 'Hall Bazaar',
        description: 'Traditional market famous for Punjabi goods',
        image: 'https://upload.wikimedia.org/wikipedia/commons/5/50/I_was_surprised_to_see_no_lightning_conductor_above_the_dome_%2838221673934%29.jpg',
        category: 'cultural'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/4/49/Ganga_Aarti_in_evening_at_Dashashwamedh_ghat%2C_Varanasi.jpg',
    bestTimeToVisit: 'November to March',
    category: 'spiritual',
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/4/49/Ganga_Aarti_in_evening_at_Dashashwamedh_ghat%2C_Varanasi.jpg',
        category: 'spiritual'
      },
      {
        name: 'Kashi Vishwanath Temple',
        description: 'One of the most sacred Shiva temples in India',
        image: 'https://upload.wikimedia.org/wikipedia/commons/e/ec/Shri_Kashi_Vishwanath_Temple_2.jpg',
        category: 'spiritual'
      },
      {
        name: 'Sarnath',
        description: 'Buddhist pilgrimage site where Buddha gave first sermon',
        image: 'https://upload.wikimedia.org/wikipedia/commons/7/75/Dhamek_Stupa_and_ancient_Buddhist_settlement_%282025%29.jpg',
        category: 'spiritual'
      },
      {
        name: 'Assi Ghat',
        description: 'Popular ghat for sunrise viewing and yoga sessions',
        image: 'https://upload.wikimedia.org/wikipedia/commons/d/de/Assi_Ghat_on_river_Ganga.jpg',
        category: 'spiritual'
      },
      {
        name: 'Banaras Hindu University',
        description: 'Prestigious university with beautiful campus and museums',
        image: 'https://upload.wikimedia.org/wikipedia/commons/1/1e/BHU_Main_Gate%2C_Banaras_Hindu_University.jpg',
        category: 'cultural'
      },
      {
        name: 'Manikarnika Ghat',
        description: 'Sacred cremation ghat central to Hindu beliefs',
        image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Manikarnika_Ghat%2C_Varanasi%2C_Uttar_Pradesh%2C_India_%282013%29.jpg',
        category: 'spiritual'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/8/8b/Pangong_Tso_2.jpg',
    ...
    attractions: [
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/e/ea/Hemis_Monastery_02.jpg',
        category: 'spiritual'
      },
      {
        name: 'Leh Palace',
        description: 'Former royal palace with panoramic Leh views',
        image: 'https://upload.wikimedia.org/wikipedia/commons/e/e4/Leh_Palace_-_Leh_-_Ladakh_-_View_from_Shanti_Stupa.jpg',
        category: 'heritage'
      },
      {
        name: 'Nubra Valley',
        description: 'High-altitude cold desert with sand dunes and camels',
        image: 'https://upload.wikimedia.org/wikipedia/commons/8/81/Sand_dunes_in_Nubra_Valley%2C_Ladakh.jpg',
        category: 'nature'
      },
      {
        name: 'Thiksey Monastery',
        description: 'Impressive monastery resembling Potala Palace',
        image: 'https://upload.wikimedia.org/wikipedia/commons/4/4d/Thiksey_Monastery%2C_Ladakh_08.jpg',
        category: 'spiritual'
      },
      {
        name: 'Magnetic Hill',
        description: 'Gravity-defying hill with optical illusion effects',
        image: 'https://upload.wikimedia.org/wikipedia/commons/a/aa/Ladakh_-_Magnetic_Hill.jpg',
        category: 'nature'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/8/87/Havelock_Island%2C_Radhanagar_Beach_before_sunset%2C_Andaman_Islands.jpg',
    ...
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/8/87/Havelock_Island%2C_Radhanagar_Beach_before_sunset%2C_Andaman_Islands.jpg',
        category: 'beach'
      },
      {
        name: 'Cellular Jail',
        description: 'Historical prison museum showcasing freedom struggle',
        image: 'https://upload.wikimedia.org/wikipedia/commons/8/81/Cellular_Jail_Andaman_outside_view.jpg',
        category: 'heritage'
      },
      {
        name: 'Neil Island',
        description: 'Coral island with natural rock formations and beaches',
        image: 'https://upload.wikimedia.org/wikipedia/commons/a/ab/Natural_Bridge_Neil_Island_India.jpg',
        category: 'beach'
      },
      {
        name: 'Elephant Beach',
        description: 'Popular snorkeling destination with vibrant coral reefs',
        image: 'https://upload.wikimedia.org/wikipedia/commons/8/8f/Snorkeling_at_Elephant_beach%2C_Havelock_Island%2CAndaman.jpg',
        category: 'beach'
      },
      {
        name: 'Ross Island',
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/d/db/Lime_Stone_Caves%2C_Baratang_Island%2C_Andaman_Island%2C_India.JPG',
        category: 'nature'
      }
    ],
    packages: [
  ...
  },
  {
    ...
    heroImage: 'https://upload.wikimedia.org/wikipedia/commons/6/63/Tsomgo_Lake%2C_Sikkim%2C_India.jpg',
    bestTimeToVisit: 'March to May, October to December',
    category: 'mountain',
    attractions: [
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/6/63/Tsomgo_Lake%2C_Sikkim%2C_India.jpg',
        category: 'nature'
      },
      {
        name: 'Rumtek Monastery',
        description: 'Important Tibetan Buddhist monastery with rich heritage',
        image: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/Rumtek_Monastery_01.jpg',
        category: 'spiritual'
      },
      {
        name: 'Nathu La Pass',
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/d/d7/Yumthang_valley%2C_Lachung_Sikkim_India_2012.jpg',
        category: 'nature'
      },
      {
        name: 'Gurudongmar Lake',
        description: 'High-altitude sacred lake with crystal clear waters',
        image: 'https://upload.wikimedia.org/wikipedia/commons/7/7e/Gurudongmar_Lake%2C_Sikkim_%286717508061%29.jpg',
        category: 'nature'
      },
      {
        name: 'Pelling',
        description: 'Hill station with views of Kanchenjunga range',
        image: 'https://upload.wikimedia.org/wikipedia/commons/e/e6/Kanchenjunga_Peak_as_viewed_from_Pelling%2C_Sikkim.jpg',
        category: 'nature'
      }
    ],
    packages: [
