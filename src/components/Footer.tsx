        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              ...
              <Link to="/packages" className="block text-sm hover:text-accent transition-colors">Packages</Link>
              <Link to="/travel-styles" className="block text-sm hover:text-accent transition-colors">Travel Styles</Link>
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              <Link to="/plan-my-trip" className="block text-sm hover:text-accent transition-colors">Trip Planning</Link>
              <Link to="/packages" className="block text-sm hover:text-accent transition-colors">Tour Packages</Link>
